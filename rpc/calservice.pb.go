...
type GetUsersGcalEventsReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetUsersGcalEventsReq) Reset() {
	*x = GetUsersGcalEventsReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_calservice_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetUsersGcalEventsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUsersGcalEventsReq) ProtoMessage() {}

func (x *GetUsersGcalEventsReq) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_calservice_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUsersGcalEventsReq.ProtoReflect.Descriptor instead.
func (*GetUsersGcalEventsReq) Descriptor() ([]byte, []int) {
	return file_rpc_calservice_proto_rawDescGZIP(), []int{9}
}

func (x *GetUsersGcalEventsReq) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *GetUsersGcalEventsReq) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
type GetUsersGcalEventsRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	EventIntervals []string `protobuf:"bytes,1,rep,name=eventIntervals,proto3" json:"eventIntervals,omitempty"`
}

func (x *GetUsersGcalEventsRes) Reset() {
	*x = GetUsersGcalEventsRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_calservice_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetUsersGcalEventsRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUsersGcalEventsRes) ProtoMessage() {}

func (x *GetUsersGcalEventsRes) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_calservice_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUsersGcalEventsRes.ProtoReflect.Descriptor instead.
func (*GetUsersGcalEventsRes) Descriptor() ([]byte, []int) {
	return file_rpc_calservice_proto_rawDescGZIP(), []int{10}
}

func (x *GetUsersGcalEventsRes) GetEventIntervals() []string {
	if x != nil {
		return x.EventIntervals
	}
	return nil
}

type GetTeamsGcalEventsReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTeamsGcalEventsReq) Reset() {
	*x = GetTeamsGcalEventsReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_calservice_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTeamsGcalEventsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTeamsGcalEventsReq) ProtoMessage() {}

func (x *GetTeamsGcalEventsReq) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_calservice_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTeamsGcalEventsReq.ProtoReflect.Descriptor instead.
func (*GetTeamsGcalEventsReq) Descriptor() ([]byte, []int) {
	return file_rpc_calservice_proto_rawDescGZIP(), []int{11}
}

func (x *GetTeamsGcalEventsReq) GetTeamID() string {
	if x != nil {
		return x.TeamID
	}
	return ""
...
type GetTeamsGcalEventsRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTeamsGcalEventsRes) Reset() {
	*x = GetTeamsGcalEventsRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_calservice_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTeamsGcalEventsRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTeamsGcalEventsRes) ProtoMessage() {}

func (x *GetTeamsGcalEventsRes) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_calservice_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTeamsGcalEventsRes.ProtoReflect.Descriptor instead.
func (*GetTeamsGcalEventsRes) Descriptor() ([]byte, []int) {
	return file_rpc_calservice_proto_rawDescGZIP(), []int{12}
}

func (x *GetTeamsGcalEventsRes) GetEventIntervals() []string {
	if x != nil {
		return x.EventIntervals
	}
	return nil
...
var file_rpc_calservice_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x49, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x73, 0x47, 0x63, 0x61, 0x6c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65,
	...
	,
}
...
var file_rpc_calservice_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_rpc_calservice_proto_goTypes = []interface{}{
	...
	(*GetUsersGcalEventsReq)(nil), // 9: GetUsersGcalEventsReq
	(*GetUsersGcalEventsRes)(nil), // 10: GetUsersGcalEventsRes
	(*GetTeamsGcalEventsReq)(nil), // 11: GetTeamsGcalEventsReq
	(*GetTeamsGcalEventsRes)(nil), // 12: GetTeamsGcalEventsRes
}
var file_rpc_calservice_proto_depIdxs = []int32{
	...
	9,  // 9: CalendarEventManagementService.GetUsersGcalEvents:input_type -> GetUsersGcalEventsReq
	11, // 10: CalendarEventManagementService.GetTeamssGcalEvents:input_type -> GetTeamsGcalEventsReq
	2,  // 11: CalendarEventManagementService.CreateEvent:output_type -> CreateEventRes
	4,  // 12: CalendarEventManagementService.UpdateEvent:output_type -> UpdateEventRes
	6,  // 13: CalendarEventManagementService.DeleteEvent:output_type -> DeleteEventRes
	8,  // 14: CalendarEventManagementService.GetEvent:output_type -> GetEventRes
	10, // 15: CalendarEventManagementService.GetUsersGcalEvents:output_type -> GetUsersGcalEventsRes
	12, // 16: CalendarEventManagementService.GetTeamssGcalEvents:output_type -> GetTeamsGcalEventsRes
...
func file_rpc_calservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_calservice_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUsersGcalEventsReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_calservice_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUsersGcalEventsRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_calservice_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTeamsGcalEventsReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_calservice_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTeamsGcalEventsRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
